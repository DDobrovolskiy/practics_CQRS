...
public class RestConfig {
    ...
    public RestTemplate restTemplate(ObjectMapper objectMapper) {
        HttpClient httpClient = HttpClientBuilder.create()
                // максимальное количество подключений (всего)
        ...
        // макс время, за которое должно быть установлено соединение
        httpRequestFactory.setConnectTimeout(CONNECTION_TIMEOUT_MS);
        // макс время, за которое должен выполниться запрос (прийти ответ)
